...
def _build_messages(
    ...
    system = (
        ...
        "critical ones. Each check must be its OWN separate array item — "
        "never combine multiple checks into one semicolon-separated string. "
        "If you have 3 checks, submit 3 separate strings, not 1 string "
        "containing all 3. Only recommend a check if something SPECIFIC about "
